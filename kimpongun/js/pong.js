...
function play(){
  ...
  var scoreP1, scoreP2 = 0; 
  function score(){
    var div1 = document.createElement("p");
    var div2 = document.createElement("p");
    
    var score1 = document.getElementById("playerScore1").value; //scoreP1 a modifier
    var j1score = document.createTextNode(score1);
    div1.appendChild(j1score);
    divj1.appendChild(div1);
    
    var score2 = document.getElementById("playerScore2").value; //scoreP2 a modifier
...
var direction = {
    ...
    function loop() {
      ...
      if (ballPosition.x + ballPosition.wdt>= largeur){
        ...
        document.getElementById("playerScore2").innerHTML = scoreP1;
        console.log("bd");
        return;
      }
      if(ballPosition.x + ballPosition.wdt <= 0){
        scoreP1 += 1;
        //direction.x = -direction.x;//a suppr
        document.getElementById("playerScore1").innerHTML = scoreP2;
        console.log("bgauche");
        return;
      }
